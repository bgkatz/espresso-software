...
class Ui_EspressoGUI(object):
    def setupUi(self, EspressoGUI):
        ...
        self.idleButton = QtWidgets.QPushButton(self.verticalWidget)
...
"}")
        ...
        self.verticalLayout_2.addWidget(self.idleButton)
        self.preheatButton = QtWidgets.QPushButton(self.verticalWidget)
...
"}")
        ...
        self.verticalLayout_2.addWidget(self.preheatButton)
...
"}")
        ...
        self.gridWidget1.setMaximumSize(QtCore.QSize(16777215, 75))
        font = QtGui.QFont()
        font.setPointSize(20)
